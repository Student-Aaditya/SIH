...
export default function StudentForm({ show, onClose, onSave, initialData }) {
  ...
  async function handleSubmit() {
    ...
    // convert interests
    toSave.interests = interestsInput
      .split(",")
      .map((s) => s.trim())
      .filter(Boolean);
  ...
  async function handleFiles(e) {
    ...
    setForm((prev) => ({
      ...prev,
      certificates: [...(prev.certificates || []), ...added],
    }));
        ...
        <div className="row g-3">
          ...
          <div className="col-md-3">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("admissionYear", Number(e.target.value))
              }
            />
          </div>
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              placeholder="Set new password (will be hashed)"
            />
          </div>
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <input
                          ...
                          value={c.title}
                          onChange={(e) =>
                            updateCertField(c.id, "title", e.target.value)
                          }
                        />
                        <input
                          type="date"
                          ...
                          value={c.issueDate}
                          onChange={(e) =>
                            updateCertField(c.id, "issueDate", e.target.value)
                          }
                        />
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => window.open(c.dataUrl, "_blank")}
                        >
                          Preview
                        </button>
                        <button
          ...
          <div className="col-12 mt-2">
            <label>
              <input
                ...
                onChange={(e) =>
                  handleChange("isOptedOut", e.target.checked)
                }
              />{" "}
